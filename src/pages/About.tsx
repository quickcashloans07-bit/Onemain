        ...
        <section className="relative container mx-auto px-4 py-20 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold mb-8">
              About <span className="text-accent">OneMain Financial</span>
            </h1>
            
            <div className="space-y-8 text-lg text-muted-foreground">
              <p>
                OneMain Financial is a leading financial services provider dedicated to empowering individuals and businesses with tailored lending solutions. Since our inception, we've been committed to making financing accessible, transparent, and efficient - with trust at the core of everything we do.
              </p>
